...
if ('POST' == $_SERVER['REQUEST_METHOD']) {
    ...
    if (!$v->errors()) {
        ...
        $query ="UPDATE  
                 Orders 
                 SET name=:name, phone=:phone,street=:street,postal_code=:postal_code,province=:province,event_name=:event_name,event_time=:event_time,donation=:donation   
...
<main>    
    ...
    <div class="container">
          ...
          <form action="<?=basename($_SERVER['PHP_SELF'])?>" method="post" enctype="multipart/form-data">  
              <fieldset> 
                <legend><strong><b>Update Order</b></strong></legend> 
